...
export default function Home() {
  ...
  const handleAnalyze = async () => {
    ...
    setAnalyzeMessage("");
    try {
      const analyzeRes = await fetch("https://codebase-time-traveler-production.up.railway.app/analyze-github", {
        method: "POST",
  ...
  const handleAsk = async () => {
    ...
    setError("");
    try {
      const askRes = await fetch("https://codebase-time-traveler-production.up.railway.app/ask-question", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
